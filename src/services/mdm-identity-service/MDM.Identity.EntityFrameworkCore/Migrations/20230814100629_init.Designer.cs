...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.Category.CategoryBase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.Price.ProductPriceHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.Product.ProductBase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.Product.ProductBundleVariant", b =>
                {
                    ...
                    b.Property<Guid>("ProductBundleColectionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ProductVariantRelated")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("ProductBundleColectionId");

                    b.HasIndex("ProductVariantRelated");
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.Product.ProductVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.Product.ProductBundleVariant", b =>
                {
                    ...
                    b.HasOne("MDM.CatalogModule.Entity.Product.ProductVariant", "ProductVariant")
                        .WithMany()
                        .HasForeignKey("ProductVariantRelated")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MDM.CatalogModule.Entity.ProductCategory", b =>
                {
                    b.HasOne("MDM.CatalogModule.Entity.Category.CategoryBase", "Category")
                        .WithMany()
