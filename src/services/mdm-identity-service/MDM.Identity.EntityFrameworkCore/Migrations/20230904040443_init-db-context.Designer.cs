...
namespace Identity.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230904040443_init-db-context")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("OrderCodes")
                .StartsAt(10000L);

            modelBuilder.HasSequence<int>("PaymentCodes")
                .StartsAt(10000L);
            ...
            modelBuilder.Entity("Identity.Core.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OrderCode")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
                        .HasDefaultValueSql("FORMAT((NEXT VALUE FOR OrderCodes), 'DH#')");
            ...
            modelBuilder.Entity("Identity.Core.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("PaymentCode")
                        ...
                        .HasDefaultValueSql("FORMAT((NEXT VALUE FOR PaymentCodes), 'PA#')");
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.CustomerModel.CustomerBase", b =>
                {
                    ...
                    b.Property<string>("CustomerCode")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(50)")
                        .HasDefaultValueSql("FORMAT((NEXT VALUE FOR CustomerCodes), 'KH#')");
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyContact.PartyIdentification", b =>
                {
                    ...
                    b.Property<Guid>("PartyIdentificationTypeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyContact.PartyIdentificationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PartyIdentificationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PartyIdentificationId")
                        .IsUnique();

                    b.ToTable("PartyIdentificationTypes");
                });
            ...
            modelBuilder.Entity("Identity.Core.Entities.Customer", b =>
                {
                    b.HasBaseType("MDM.CustomerModule.Entity.CustomerModel.CustomerBase");
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyModel.Organization", b =>
                {
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyAssignment.PartyRoleAssignment", b =>
                {
                    b.HasOne("MDM.CustomerModule.Entity.PartyModel.PartiesBase", null)
                        .WithMany("PartyRoleAssignments")
                        .HasForeignKey("PartiesBaseId");
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyContact.PartyContactMethod", b =>
                {
                    ...
                    b.HasOne("MDM.CustomerModule.Entity.PartyContact.Website", "Website")
                        .WithMany()
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyContact.PartyIdentificationType", b =>
                {
                    b.HasOne("MDM.CustomerModule.Entity.PartyContact.PartyIdentification", "PartyIdentification")
                        .WithOne("PartyIdentificationType")
                        .HasForeignKey("MDM.CustomerModule.Entity.PartyContact.PartyIdentificationType", "PartyIdentificationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.PartyModel.Organization", b =>
                {
                    b.HasOne("MDM.CustomerModule.Entity.PartyModel.PartiesBase", null)
                        .WithOne()
                        .HasForeignKey("MDM.CustomerModule.Entity.PartyModel.Organization", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MDM.CustomerModule.Entity.Person.PersonBase", b =>
                {
                    b.HasOne("MDM.CustomerModule.Entity.PartyModel.PartiesBase", null)
                        .WithOne()
                        .HasForeignKey("MDM.CustomerModule.Entity.Person.PersonBase", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
