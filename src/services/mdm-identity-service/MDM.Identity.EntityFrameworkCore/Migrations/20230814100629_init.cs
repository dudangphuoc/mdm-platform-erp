        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentId = table.Column<string>(type: "nvarchar(256)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtensionGroup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtensionName_ExtensionGroup_GroupId",
                        column: x => x.GroupId,
                        principalTable: "ExtensionGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockTrackingIsEnabled = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    MarkAsNew = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductBase_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductBase_ProductUnit_ProductUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductBundles_ProductBase_ProductBaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCategories_ProductBase_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductMedia_ProductBase_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialPriceFromDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SpecialPriceToDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPriceHistory_ProductBase_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariant_ProductBase_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductBundleColections_ProductBase_ProductRelated",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branch_Parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "Parties",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Branch_PartyRoleAssignments_PartyRoleAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAtrributeValue", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerAtrributeValue_Branch_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branch",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomerAtrributeValue_CustomerAttribute_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "CustomerAttribute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerAtrributeValue_Employee_EmployeeBaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branch_PartyRoleAssignmentId",
                table: "Branch",
                column: "PartyRoleAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAtrributeValue_AttributeId",
                table: "CustomerAtrributeValue",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAtrributeValue_BranchId",
                table: "CustomerAtrributeValue",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAtrributeValue_EmployeeBaseId",
                table: "CustomerAtrributeValue",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductBase_BrandId",
                table: "ProductBase",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductBase_ProductUnitId",
                table: "ProductBase",
