        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    OrderCode = table.Column<string>(type: "varchar(50)", nullable: false, defaultValueSql: "FORMAT((NEXT VALUE FOR OrderCodes), 'DH#')"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrganizationName = table.Column<string>(type: "nvarchar(500)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmailId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PartyIdentificationTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartyIdentification_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartyIdentification_Emails_EmailId",
                        column: x => x.EmailId,
                        principalTable: "Emails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartyIdentification_TelePhones_TelePhoneId",
                        column: x => x.TelePhoneId,
                        principalTable: "TelePhones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartiesBaseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartyRoleAssignments_Parties_PartiesBaseId",
                        column: x => x.PartiesBaseId,
                        principalTable: "Parties",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    ReceiptId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PaymentCode = table.Column<string>(type: "varchar(100)", nullable: false, defaultValueSql: "FORMAT((NEXT VALUE FOR PaymentCodes), 'PA#')"),
            ...
            migrationBuilder.CreateTable(
                name: "PartyIdentificationTypes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PartyIdentificationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "varchar(200)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartyIdentificationTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartyIdentificationTypes_PartyIdentification_PartyIdentificationId",
                        column: x => x.PartyIdentificationId,
                        principalTable: "PartyIdentification",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonymousFlag = table.Column<bool>(type: "bit", nullable: false),
                    CustomerCode = table.Column<string>(type: "varchar(50)", nullable: false, defaultValueSql: "FORMAT((NEXT VALUE FOR CustomerCodes), 'KH#')"),
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PartyRoleAssignmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PartyContactTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EmailId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AddressId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TelephoneId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartyContactMethod_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PartyContactMethod_Emails_EmailId",
                        column: x => x.EmailId,
                        principalTable: "Emails",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartyContactMethod_TelePhones_TelephoneId",
                        column: x => x.TelephoneId,
                        principalTable: "TelePhones",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PartyContactMethod_Websites_WebsiteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartyContactMethod_AddressId",
                table: "PartyContactMethod",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyContactMethod_EmailId",
                table: "PartyContactMethod",
                column: "EmailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartyContactMethod_TelephoneId",
                table: "PartyContactMethod",
                column: "TelephoneId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyContactMethod_WebsiteId",
                table: "PartyContactMethod",
                column: "WebsiteId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyIdentification_AddressId",
                table: "PartyIdentification",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyIdentification_EmailId",
                table: "PartyIdentification",
                column: "EmailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartyIdentification_TelePhoneId",
                table: "PartyIdentification",
                column: "TelePhoneId");

            migrationBuilder.CreateIndex(
                name: "IX_PartyIdentificationTypes_PartyIdentificationId",
                table: "PartyIdentificationTypes",
                column: "PartyIdentificationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PartyRoleAssignments_PartiesBaseId",
                table: "PartyRoleAssignments",
                column: "PartiesBaseId");
